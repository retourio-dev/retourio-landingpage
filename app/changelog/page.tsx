  ...
  const logs = [
    {
      ...
      title: 'Modularer Umbau & ERP Integration',
      changes: [
        'Landing Page in Module zerlegt (Navbar, Hero, ROI, etc.)',
        'Mock-API für Shopify/Xentral Bestellabruf implementiert',
        'Zahlungsabwicklung via Stripe vorbereitet',
        'DNS-Setup für purelymail.com abgeschlossen',
      ],
    },
    {
      version: 'v0.1.0',
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto py-24 px-6">
        ...
        <p className="text-slate-500 font-medium mb-16 text-xl">
          Alle Updates und Verbesserungen von retourio.app auf einen Blick.
        </p>

        <div className="space-y-16">
          {logs.map((log, i) => (
            <div key={i} className="relative pl-12 border-l-4 border-slate-100">
